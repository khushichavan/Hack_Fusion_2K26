  ...
  head: () => ({
    meta: [
      { title: "Services — AquaFlow" },
      {
        name: "description",
        content:
          "Water supply, demand management, allocation dashboards and audit logs for urban utilities.",
      },
    ],
  }),
  component: Services,
      ...
      <div className="relative bg-[var(--gradient-hero)] pb-24 pt-32 text-white">
        ...
        <div className="container mx-auto px-6 text-center">
          ...
          <p className="mx-auto mt-4 max-w-2xl text-white/85">
            Everything cities need to manage water fairly.
          </p>
        </div>
      </div>
        ...
        {[
          {
            ...
            desc: "Set reservoir totals, schedule releases and monitor capacity.",
          },
          {
            title: "Demand Requests",
            desc: "Citizens request additional allocations bound to their location.",
          },
          {
            title: "Allocation Engine",
            desc: "Auto-distribute supply, prioritize critical areas, and resolve conflicts.",
          },
          {
            title: "Time-Limited Tokens",
            desc: "Each allocation expires after a configurable window.",
          },
        ].map((s) => (
